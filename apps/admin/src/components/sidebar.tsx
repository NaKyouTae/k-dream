...
export function Sidebar({ open = false, onNavigate, me }: Props) {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 flex w-64 shrink-0 flex-col border-r border-border bg-surface transition-transform duration-200 md:static md:w-56 md:translate-x-0 ${
